/**
 * Dibuja el fractal "Árbol de Pitágoras" no simétrico a
 * 30 y 60 grados

 * Referencia:
 *  - Buch: Gunter Saake Kai-Uwe Sattler (2021). Algorithmen and Datenstrukturen
 *    Eine Einführung mit Java Programm 3.3 Programm zum Darstellen des Pythagoras-Baumes
...
public class ArbolPitagorasNoSimetrico30y60 extends JFrame {
    ...
    void paintTree(Graphics g, double x1, double y1,
         ...
         *  del triángulo rectángulo de catetos dx y dy
